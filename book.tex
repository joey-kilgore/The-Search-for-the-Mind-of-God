...
As a note on the structure of this book, because it is meant for both the atheist scientist and the non-academic Christian, sometimes the audience will flip. Part of trying to bridge the gap means we need to have the conversation as a group. We need to see be able to put on each others shoes.
...
Albert Einstein
\footnote{https://blogs.sciencemag.org/sciencecareers/2011/01/an-interview-wi.html}
\end{center}
\vspace*{\fill}
...
On a cold Florida morning at Kennedy Space Center Launch Complex 39, a space shuttle launch as part of  NASA mission STS-51-L was under way \cite{Challenger1986}. The temperature on the site was measured to have dropped to 22 degrees Fahrenheit over night. Additionally, due to the large tanks of supercooled liquid hidrogen and liquid oxygen, the wind created pockets of air around the base of the shuttle that were measured at 8 degrees Fahrenheit. Concerns were brought up many times that the O-rings of the shuttle should be at a minimum of 53 degrees Fahrenheit to be fully functional.
...
At 7:05PM Central Daylight Time in Kansas City, Missouri, guests at Hyatt Regency Hotel heard large pops from the fourth-floor walkway \cite{Marshall1982}. The pops were paired with a four inch drop of the fourth floor walkway before the entire walkway gave way and fell down on top of the second floor bridge which also subsequently collapsed under the additional weight.

At the time there were approximately 40 people on the second floor bridge, 20 on the fourth floor walkway, and approximately 1,600 people gathered in the atrium below for an event. The collapse caused 114 deaths and 216 non-fatal injuries, and the rescue operation lasted 14 hours. This event remains the deadliest non-deliberate structural failure in American history. See Appendix \ref{appendix:hyatt} for a list of most of the names of those lost.

\begin{figure}[h!]
\centering
\includegraphics[width=0.4\textwidth]{./figs/hyatt.jpg}
\includegraphics[width=0.4\textwidth]{./figs/hyatt2.jpg}
\caption{Image of box beam at location 9UE. Taken from \cite{Marshall1982}}
\label{fig:hyatt}
\end{figure}

The cause of the accident was a change during the construction of the walkway in which two vertical rods supporting the walkway were placed through the horizontal support beam on a welded joint as oppose to one single rod all the way from the second to fourth floor. This poor design caused the rod and nut to be pulled up through the welding joint under load, causing a popping sound and four inch drop before the nut would be caught on the opposing side of the beam, but would then (a few seconds later) rip through the opposite side of the beam completely coming out and dropping the entire weight of the walkway.

114 deaths and 216 injuries, over a \$100 million dollars in settlements paid, all because of a relatively trivial design flaw that could have been fixed with stiffener plates or a bearing plate.

\subsection{August 29, 1907}
Across the St. Lawrence River was a bridge in the process of being built \cite{Pearson2006}. The Quebec Bridge would become the largest cantilever bridge in the world upon completion and would be a feat of engineering. Originally, the design was set to be a large cantilever bridge, but upon the request of the engineer, Theodore Cooper, it was lengthened to what would now be the largest in the world (the pinnacle of Cooper's long and successful career). However, workers had noted that prior to this day, and in the previous months, some of the members of the structure appeared to have been bending (and deflection measurements had been taken to show this), but it was passed as an error in material manufacturing and that the structure was believed to remain stable. Earlier in the day, Theodore Cooper finally agreed that the issue was serious and sent a telegraph from New York to the Phoenix Bridge Company (who were hired to design and construct the bridge) that they should ``add no more load to the bridge till after due consideration of facts."

That message was not given to the construction site before that afternoon when the south arm of the bridge collapsed into the river. At the time of the collapse, 86 workers were on the bridge, and 75 of those were killed in the collapse, leaving 11 injured. Throughout the aftermath, the Royal Commission began analyzing the disaster to determine the root cause. Of their 15 conclusions, 3 of them give a deep look at the fundamental problems.
...
Royal Commission Report \cite{Schneider1908}
\end{center}
...
But what about in general? I'm not launching a space shuttle into space space on a daily basis. It's note everyday that you're building or planning out the world's largest cantilever bridge. But everyday I make decisions. Everyday I have interactions with other people. Let's take a look at what we should do.
...
Obligation of the Engineer \cite{obligation2021}
\end{center}
...
\chapter{The Loneliness of Science}
While we are talking about science and trying to understand the proper mindset of the scientist, I think we should discuss some of the other social and emotional aspects of the academic worldview. Science is not just something few people understand the process for, but few people understand the culture that goes with it. Have you ever had someone ask you what you do? For me it's a constant reminder that no one outside academia will ever really understand what the world is like in academia. The conversations I had leading up to starting my PhD have stuck out in my mind.

\begin{flushleft}
So what are you doing now that you graduated?\\
I'm actually going to grad school!\\
Oh that sounds awesome! What are you going for?\\
A PhD in Computer Engineering.\\
Oh so you are going to do hardware or like programming?\\
Well I'm going to be looking at biologically inspired machine learning algorithms.
\end{flushleft}

And at that moment you can see a look on the person's face like they have no clue what you just said. Maybe you understood all the words put together, but I'm almost certain that you don't know what that \textit{really} means, or what it really entails. My next 4+ years of work, and it will never be understood by the vast majority of people. Loan officer, car salesman, school teacher, \textit{etc.} are professions people easily understand, but unless you are in research, then you don't understand it. It's a different world. And there is a moment when you see someone's face and you watch them quickly go from thinking they understand what you do, just going to grad school, to instantly having no idea. You can see that your life is just so far away from the average person that they just can't understand it anymore. And that moment when you see it switch on their face is a constant reminder that you're always somewhat on the outside.

You could argue that I just need to explain it in a more simplified way, or that I could make it more relatable. But it's not relatable. Should I say, ``I'm making AI that works like your brain''? Regardless of how I phrase it, only a very select few people will be able to continue that conversation with any level of depth.

\section{Work = Life}
I think the next isolating problem that I have particularly noticed growing up with a researcher, is that our work is our lives, and we don't just turn it off. We live to ask questions. And not surface level questions, and not general life questions, but rather deep topic-specific questions. Regularly me and dad would be discussing electrical nerve block at the dinner table. Not because I was behind on work and needed new ideas, but because asking deep questions is what we do! I can't have those conversations with just anyone. I can't go to a local game group and talk about NEURON modeling over a game of Carcassonne. I can't go to my bible study and talk about memristive technology after our study. People outside of the bubble just can't get through a conversation without the years of background information needed. And at the end of the day, I can't say ``something is wrong with them. Why can't they just understand,'' because I've had years to build the foundational knowledge.

It's lonely sometimes to have tons of questions and no one that can talk about them. When I'm surrounded by other researchers, I have a level of conversation that I can't have with anyone.

This is just something that is a defining feature of a lot of people who truly love their research. They can't stop talking about it. It's a fixation on a question (or questions) that enthrolls someone. That's partly a good thing. If you are going to go around pan handling for money (what some people refer to as `grant writing') then you need to believe and be interested in your topic. Similar to how someone starting a business, the work becomes their life.

I've seen some people arguing that there is an unhealthy work life balance in academia, and that is certainly true for some people. People get frustrated that they would have to work weekends in academia. I grew up thinking that a 8 to 5 was a normal work week. This was because every morning my dad would leave for work by 7 and was home at 6 everyday. When I asked my dad why he then also works on the weekends he responded with ``well, if some people are going to work on dangerous construction zones high up in the air, then I think I can work a bit on the weekends.'' It was pretty hard to argue with that, but I think it just goes back to a deeper want to solve a problem. 

I distinctly remember one week where I had a project at work that I wanted to work on, and so I worked on it at a hackathon. For those that don't know, a hackathon is a place where `hackers' (programmers, electronics enthusiasts, graphic designers, makers, etc.) gather together and in one weekend go from idea to working prototype. One hackathon was a 24hr hackathon, starting friday night and ending saturday night. I spent the entire 24hrs writing C code for a project I wanted to do for my research, and I mean that I spend the \textit{entire} 24hrs. That night, me and two other programmers drank approximately 2 grams of caffeinne (2 strong energy drinks each) and wrote code for a project for my work. Yes, it was extremely cool, interesting, and really pushed our skills while also learning new ones. Then when I was done with the hackathon, I then kept working on the project. In fact, I kept working on the project so much that I remember a week where everyday I woke up and went to work for 8 hours working on the project (where I usually didn't take a lunch break) and then went home, ate dinner, and worked on the project until I fell asleep at 11. I did that for an entire work week. Some people feel like they get `burnt out', and I genuinely believe that happens for some people, but for me, if I'm working on something that I really love then I can just keep working.

After my first year of college, I went right to a summer internship the week after finals. I worked at Hyland until the week before the fall semester started. During the fall semester I started working at Case, and kept working there with 1 week off for Christmas/New Years for that winter break, and continued working at Case with no vacation for the next year. By the end of 2019 I had realized I had been working continuously for 2 years, with a single week off (I had vacation time, but I never used it). Please do not take this as an encouragement to overwork yourself. I do not think that working yourself beyond your limit is healthy. What I am trying to say is that my level at which I feel overworked is higher than the average, and it's something that I see common in researchers. This often is viewed as a blessing in the US, where having a packed calendar is a badge to wear proudly, but it can also be a curse. There is always a fear in the back of my head that I could become the next old researcher that never started a family, literally lives in his office\footnote{As an example, Richard Stallman (a free software activist) while working for MIT had his official voting address set as his office address. https://stallman.org/rms-lifestyle.html}, and his work is the \textit{only} thing he does. Some of them get to the age where they can finally retire, but never leave because they have nothing left in their lives. The need to have questions and find answers is such an all consuming quest, that without it they quite literally are just a shell.

\section{The silent office}
This section varies depending on a particular group, so it certainly isn't a rule, but it is more often than not the truth. The work we do is often extremely individual. As a programmer in industry, we would have meetings everyday, our workspaces were all connected so we could quickly jump over to help eachother work through problems. The environment there was about working together on common well defined goals that everyone was working towards. In research, everyone has their own questions they want to answer, their own sets of tools to do it, and the majority of collaboration comes from scheduled meetings where we communicate the hours upon hours of work done leading up to it.

This working alone was particularly true at my first research job because I was the only programmer on the team at the time. No one else focused on creating the NEURON models, compiling code, multithreading simulations, etc. And this meant that I had a lot more freedom to solve problems the way I wanted to. But that meant I was the only one that could solve the problems. In some ways this is typical in research. We hire people with different skillsets because that adds to our teams repetoire. Being able to have a wide set of skills means we can collectively ask a wider set of problems that increase our ability to navigate through the ever complex web of information we are searching through. Unfortunetely, this can lead to being the `expert' on something as a second year undergraduate student in a room of PhD's, and that scared me. Sometimes it was hard to try and step up to the plate. It was hard to just work through the confusion, but that is part of research. It takes some growth as a researcher to realize that you aren't suppose to know everything, but given time you can attempt to figure out an answer.

My first office was actually a lab room next to my boss. It was about 20ft by 8ft, and I sat at the far side facing the giant window. Every day I would walk in, set my bag down, take out my laptop and charger, plug into my extra monitor (or 2 extra monitors), put on my headphones, and start working. There were rarely specific things I needed to do, and often it was just general questions I was trying to solve. I did everything how I wanted, and then when I was done I would present what I did, why I did it, what the results were, and possible next steps. Often times my boss (who was absolutely amazing, and defines a great boss in my opinion) would see me at the end of the day to say he was going home, and asked if I had enough work to do. To which I would almost always reply with ``yes'' and that would be the entire human interaction for that day. This is definetely a bit extreme. Not everyone is a programmer sitting in a room by themselves, but it was \textit{my} experience. It gets lonely sometimes. It is often a silent office filled with lots of thoughts, lots of questions, and often very few answers. 

Not everyone will understand it. Not everyone will want to work like that, and certainly it is not the only way to do research. But this is something that seems to be pretty common across lots of researchers, and it is my experience, and I love it even if it does get lonely.
...
\textit{Strength to Love} Martin Luther King Jr.
\end{center}
\vspace*{\fill}
